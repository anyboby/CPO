...
class FakeEnv:
    ...
    def step(self, obs, act, deterministic=False):
        ...
        ensemble_model_means[:,:,:-1] += obs[:,-22:]                                                         #### models output state change rather than state completely
        ...
        next_obs = np.concatenate((obs, next_obs), axis=-1)
        next_obs = np.delete(next_obs, slice(22),-1)
